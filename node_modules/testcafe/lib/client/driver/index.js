			...
			"client": {
				...
				"driver": {
					"command-executors": {
						...
						"execute-child-window-selector.js": function (exports, module, require) {
							

							exports.__esModule = true;
							exports.default = executeChildWindowSelector;
							...
							function executeChildWindowSelector(selector, childWindowLinks) {
							    if (typeof selector === 'string') {
							        var foundChildWindowDriverLink = childWindowLinks.filter(function (link) {
							            return link.pageId === selector;
							        })[0];
						...
						"iframe": {
							"child.js": function (exports, module, require) {
								...
								var ChildDriverLink = function () {
								    ...
								    ChildDriverLink.prototype.sendConfirmationMessage = function sendConfirmationMessage(requestMsgId) {
							...
							"parent.js": function (exports, module, require) {
								...
								var ParentDriverLink = function () {
								    ...
								    ParentDriverLink.prototype.sendConfirmationMessage = function sendConfirmationMessage(requestMsgId) {
								        (0, _sendConfirmationMessage3.default)({
								            requestMsgId: requestMsgId,
								            window: this.driverWindow
								        });
						...
						"window": {
							"child.js": function (exports, module, require) {
								...
								var ChildWindowDriverLink = function () {
								    function ChildWindowDriverLink(driverWindow, pageId) {
					...
					"driver.js": function (exports, module, require) {
						...
						var _executeChildWindowSelector = require('./command-executors/execute-child-window-selector');

						var _executeChildWindowSelector2 = _interopRequireDefault(_executeChildWindowSelector);
						...
						var COMMAND_EXECUTION_CHECK_DELAY = 1000;
						...
						var Driver = function () {
						    function Driver(testRunId, communicationUrls, runInfo, options) {
						        ...
						        _hammerhead2.default.on(_hammerhead2.default.EVENTS.windowClosed, function (e) {
						            return _this._onChildWindowClosed(e);
						        });
						    ...
						    Driver.prototype._onChildWindowOpened = function _onChildWindowOpened(e) {
						        var childWindowDriverLink = new _child4.default(e.window, e.pageId);
						    ...
						    Driver.prototype._onChildWindowClosed = function _onChildWindowClosed() {
						    ...
						    Driver.prototype._addIframeChildDriverLink = function _addIframeChildDriverLink(id, driverWindow) {
						    ...
						    Driver.prototype._handleSetAsMasterMessage = function _handleSetAsMasterMessage(msg, wnd) {
						        ...
						        Promise.resolve().then(function () {
						            ...
						            var pageId = _this3._getCurrentPageId();

						            return _testcafeCore.browser.setActivePageId(_this3.browserActivePageId, _hammerhead2.default.createNativeXHR, pageId);
						        }).then(function () {
						            _this3._startInternal();
						        }).catch(function () {
						    ...
						    Driver.prototype._handleCloseAllWindowsMessage = function _handleCloseAllWindowsMessage(msg, wnd) {
						        ...
						        this._closeAllChildWindows().then(function () {
						            ...
						            _this4._onReady(new _status2.default({
						                isCommandResult: true,
						    ...
						    Driver.prototype._initChildDriverListening = function _initChildDriverListening() {
						        ...
						        messageSandbox.on(messageSandbox.SERVICE_MSG_RECEIVED_EVENT, function (e) {
						            ...
						            if (msg.type === _messages.TYPE.establishConnection) _this5._addIframeChildDriverLink(msg.id, window);else if (msg.type === _messages.TYPE.setAsMaster) _this5._handleSetAsMasterMessage(msg, window);else if (msg.type === _messages.TYPE.closeAllChildWindows) _this5._handleCloseAllWindowsMessage(msg, window);
						        });
						    };
						    ...
						    Driver.prototype._runInActiveIframe = function _runInActiveIframe(command) {
						        ...
						        runningChain.then(function () {
						            _this6.contextStorage.setItem(_this6.EXECUTING_IN_IFRAME_FLAG, true);

						            return _this6.activeChildIframeDriverLink.executeCommand(command, _this6.speed);
						        }).then(function (status) {
						            return _this6._onCommandExecutedInIframe(status);
						        }).catch(function (err) {
						            return _this6._onCommandExecutedInIframe(new _status2.default({
						                isCommandResult: true,
						                executionError: err
						            }));
						        });
						    ...
						    Driver.prototype._ensureChildIframeDriverLink = function _ensureChildIframeDriverLink(iframeWindow, ErrorCtor, selectorTimeout) {
						        ...
						        return (0, _testcafeCore.waitFor)(function () {
						            return _this7._getChildIframeDriverLinkByWindow(iframeWindow);
						    ...
						    Driver.prototype._ensureChildWindowDriverLink = function _ensureChildWindowDriverLink(childWindow, ErrorCtor, timeout) {
						        ...
						        return (0, _testcafeCore.waitFor)(function () {
						            return _this8._getChildWindowDriverLinkByWindow(childWindow);
						    ...
						    Driver.prototype._switchToIframe = function _switchToIframe(selector, iframeErrorCtors) {
						        ...
						        return (0, _executeSelector.getResult)(selector, commandSelectorTimeout, null, function (fn) {
						            ...
						            return _this9._ensureChildIframeDriverLink(nativeMethods.contentWindowGetter.call(iframe), iframeErrorCtors.NotLoadedError, commandSelectorTimeout);
						        }).then(function (childDriverLink) {
						            childDriverLink.availabilityTimeout = commandSelectorTimeout;
						            _this9.activeChildIframeDriverLink = childDriverLink;
						            _this9.contextStorage.setItem(ACTIVE_IFRAME_SELECTOR, selector);
						        });
						    };

						    Driver.prototype._waitForCommandCompletion = function _waitForCommandCompletion() {
						        var _this10 = this;

						        return (0, _testcafeCore.waitFor)(function () {
						            return !_this10.contextStorage.getItem(_this10.COMMAND_EXECUTING_FLAG);
						    ...
						    Driver.prototype._switchToChildWindow = function _switchToChildWindow(selector) {
						        ...
						        return (0, _executeChildWindowSelector2.default)(selector, this.childWindowDriverLinks).then(function (driverWindow) {
						            return _this11._ensureChildWindowDriverLink(driverWindow, _testRun.ChildWindowIsNotLoadedError, _this11.childWindowReadyTimeout);
						        }).then(function (childWindowDriverLink) {
						            _this11.activeChildWindowDriverLink = childWindowDriverLink;

						            return _this11._waitForCommandCompletion();
						        }).then(function () {
						            _this11._stopInternal();

						            return _testcafeCore.browser.setActivePageId(_this11.browserActivePageId, _hammerhead2.default.createNativeXHR, _this11.activeChildWindowDriverLink.pageId);
						        }).then(function () {
						            return _this11.activeChildWindowDriverLink.setAsMaster();
						        }).then(function () {
						            _this11.contextStorage.setItem(_this11.PENDING_WINDOW_SWITCHING_FLAG, false);
						        }).catch(function () {
						            _this11.contextStorage.setItem(_this11.PENDING_WINDOW_SWITCHING_FLAG, false);

						            _this11._onReady(new _status2.default({
						                isCommandResult: true,
						                executionError: new _testRun.CannotSwitchToWindowError()
						            }));
						        });
						    ...
						    Driver.prototype._switchToParentWindowInternal = function _switchToParentWindowInternal(parentWindowSwitchFn) {
						        ...
						        return Promise.resolve().then(function () {
						            _this12._stopInternal();

						            return parentWindowSwitchFn();
						        }).then(function () {
						            _this12.contextStorage.setItem(_this12.PENDING_WINDOW_SWITCHING_FLAG, false);
						        }).catch(function () {
						            _this12.contextStorage.setItem(_this12.PENDING_WINDOW_SWITCHING_FLAG, false);

						            _this12._onReady(new _status2.default({
						                isCommandResult: true,
						                executionError: new _testRun.CannotSwitchToWindowError()
						            }));
						        });
						    ...
						    Driver.prototype._onActionCommand = function _onActionCommand(command) {
						        ...
						        startPromise.then(function () {
						            return _this13.contextStorage.setItem(_this13.COMMAND_EXECUTING_FLAG, true);
						        });

						        completionPromise.then(function (driverStatus) {
						            _this13.contextStorage.setItem(_this13.COMMAND_EXECUTING_FLAG, false);

						            return _this13._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onNavigateToCommand = function _onNavigateToCommand(command) {
						        ...
						        (0, _executeNavigateTo2.default)(command).then(function (driverStatus) {
						            _this14.contextStorage.setItem(_this14.COMMAND_EXECUTING_FLAG, false);

						            return _this14._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onExecuteClientFunctionCommand = function _onExecuteClientFunctionCommand(command) {
						        ...
						        executor.getResultDriverStatus().then(function (driverStatus) {
						            _this15.contextStorage.setItem(EXECUTING_CLIENT_FUNCTION_DESCRIPTOR, null);
						            _this15._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onExecuteSelectorCommand = function _onExecuteSelectorCommand(command) {
						        ...
						        (0, _executeSelector.getResultDriverStatus)(command, this.selectorTimeout, startTime, createError, createError, this.statusBar).then(function (driverStatus) {
						            _this16.contextStorage.setItem(SELECTOR_EXECUTION_START_TIME, null);
						            _this16._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onSwitchToIframeCommand = function _onSwitchToIframeCommand(command) {
						        ...
						        this._switchToIframe(command.selector, ACTION_IFRAME_ERROR_CTORS).then(function () {
						            return _this17._onReady(new _status2.default({ isCommandResult: true }));
						        }).catch(function (err) {
						            return _this17._onReady(new _status2.default({
						                isCommandResult: true,
						                executionError: err
						            }));
						        });
						    ...
						    Driver.prototype._onBrowserManipulationCommand = function _onBrowserManipulationCommand(command) {
						        ...
						        (0, _browserManipulation2.default)(command, this.selectorTimeout, this.statusBar).then(function (driverStatus) {
						            _this18.contextStorage.setItem(_this18.COMMAND_EXECUTING_FLAG, false);
						            return _this18._onReady(driverStatus);
						        });
						    };
						    ...
						    Driver.prototype._onHideAssertionRetriesStatusCommand = function _onHideAssertionRetriesStatusCommand(command) {
						        ...
						        this.statusBar.hideWaitingAssertionRetriesStatus(command.success).then(function () {
						            return _this20._onReady(new _status2.default({ isCommandResult: true }));
						        });
						    };
						    ...
						    Driver.prototype._checkStatus = function _checkStatus() {
						        ...
						        return _testcafeCore.browser.checkStatus(this.browserStatusDoneUrl, _hammerhead2.default.createNativeXHR, { manualRedirect: true }).then(function (_ref2) {
						            ...
						            var isSessionChange = redirecting && command.url.indexOf(_this21.testRunId) < 0;

						            if (isSessionChange) {
						                storages.clear();
						                storages.lock();
						            } else _this21.contextStorage.setItem(TEST_DONE_SENT_FLAG, false);

						            if (redirecting) _testcafeCore.browser.redirect(command);else _this21._onReady({ isCommandResult: false });
						        }).catch(function () {
						    ...
						    Driver.prototype._onCustomCommand = function _onCustomCommand(command) {
						        ...
						        handler(command).then(function (result) {
						            _this22._onReady(new _status2.default({ isCommandResult: true, result: result }));
						        });
						    };
						    ...
						    Driver.prototype._closeAllChildWindows = function _closeAllChildWindows() {
						        ...
						        return Promise.all(this.childWindowDriverLinks.map(function (childWindowDriverLink) {
						            ...
						            nativeMethods.arrayForEach.call(_this23.childWindowDriverLinks, function (childWindowDriverLink) {
						    ...
						    Driver.prototype._onTestDone = function _onTestDone(status) {
						        ...
						        if (this.parentWindowDriverLink) this._switchToTopParentWindow();else {
						            this._closeAllChildWindows().then(function () {
						                return _this24._sendStatus(status);
						            }).then(function () {
						                _this24._checkStatus();
						            });
						        }
						    };
						    ...
						    Driver.prototype._onReady = function _onReady(status) {
						        ...
						        var thereIsPendingSwitchToChildWindow = this.contextStorage.getItem(this.PENDING_WINDOW_SWITCHING_FLAG);

						        if (thereIsPendingSwitchToChildWindow) return;

						        this._sendStatus(status).then(function (command) {
						            if (command) _this25._onCommand(command);

						            // NOTE: the driver gets an empty response if TestRun doesn't get a new command within 2 minutes
						            else _this25._onReady(new _status2.default());
						        });
						    };
						    ...
						    Driver.prototype._onCommand = function _onCommand(command) {
						        ...
						        this.readyPromise.then(function () {
						            ...
						            var pendingPageError = _this26.contextStorage.getItem(PENDING_PAGE_ERROR);

						            if (pendingPageError && isCommandRejectableByError) {
						                _this26._onReady(new _status2.default({ isCommandResult: true }));
						                return;
						            }
						            ...
						            var isThereActiveIframe = _this26.activeChildIframeDriverLink || _this26.contextStorage.getItem(ACTIVE_IFRAME_SELECTOR);

						            if (!_this26._isExecutableInTopWindowOnly(command) && isThereActiveIframe) {
						                _this26._runInActiveIframe(command);
						                return;
						            }

						            _this26._executeCommand(command);
						        });
						    };

						    Driver.prototype._getCurrentPageId = function _getCurrentPageId() {
						    ...
						    Driver.prototype._setupAssertionRetryIndication = function _setupAssertionRetryIndication() {
						        ...
						        this.readyPromise.then(function () {
						            _this27.statusBar.hidePageLoadingStatus();

						            var assertionRetriesTimeout = _this27.contextStorage.getItem(ASSERTION_RETRIES_TIMEOUT);

						            if (assertionRetriesTimeout) {
						                var startTime = _this27.contextStorage.getItem(ASSERTION_RETRIES_START_TIME);
						                var timeLeft = assertionRetriesTimeout - (new Date() - startTime);

						                if (timeLeft > 0) _this27.statusBar.showWaitingAssertionRetriesStatus(assertionRetriesTimeout, startTime);
						            }
						        });
						    };

						    Driver.prototype._startCommandsProcessing = function _startCommandsProcessing() {
						    ...
						    Driver.prototype._initParentWindowLink = function _initParentWindowLink() {
						        this.parentWindowDriverLink = new _parent2.default(window);
						    };

						    Driver.prototype._getDriverRole = function _getDriverRole() {
						        var currentPageId = this._getCurrentPageId();

						        if (!currentPageId) return Promise.resolve(_role2.default.master);

						        return _testcafeCore.browser.getActivePageId(this.browserActivePageId, _hammerhead2.default.createNativeXHR).then(function (_ref3) {
						            var activePageId = _ref3.activePageId;

						            return activePageId === currentPageId ? _role2.default.master : _role2.default.replica;
						        });
						    };
						    ...
						    Driver.prototype.start = function start() {
						        ...
						        this._getDriverRole().then(function (role) {
						            if (role === _role2.default.master) _this28._startInternal();else _this28._initParentWindowLink();
						        });
						    };
