			...
			"client": {
				"browser": {
					"index.js": function (exports, module, require) {
						...
						exports.setActivePageId = setActivePageId;
						...
						function getActivePageId(activePageIdUrl, createXHR) {
						    return sendXHR(activePageIdUrl, createXHR);
						}

						function setActivePageId(activePageIdUrl, createXHR, pageId) {
						    return sendXHR(activePageIdUrl, createXHR, {
						        method: 'POST',
						        data: JSON.stringify({ pageId: pageId }) //eslint-disable-line no-restricted-globals
						    });
						}
					}
				},
